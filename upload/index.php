...
<head>
    <meta charset="utf-8">
    <title>CBR - Administrar imágenes</title>
...
<body>
    <div class="main">
        <h1>Administrar imágenes - Conservador Bienes Raíces</h1>
        <br>
                ...
                <form name="MiForm" id="MiForm" method="post" action="cargar.php" enctype="multipart/form-data">
                    ...
                    <div style="display: column;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="tipoRegistro">
                                    <option value="" disabled selected hidden>Seleccione tipo de Registro</option>
                        ...
                        <div style="display: column;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label">Foja inicial:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="fojaInicial" />
                                </div>
                            </div>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3>Eliminar imágenes</h4>
            </div>
            <div class="panel-body">
                <form name="EliminarForm" id="EliminarForm" method="post" action="eliminar.php">
                    <div style="display: column;">
                        <div class="form-group">
                            <label class="col-sm-1 control-label">Tipo de Registro:</label>
                            <div class="col-sm-3">
                                <select class="form-control" name="tipoRegistroEliminar">
                        ...
                        <div class="form-group">
                            <label class="col-sm-1 control-label">Año:</label>
                            <div class="col-sm-3">
                                <input type="text" class="form-control" name="annoEliminar" />
                            </div>
                        </div>
                        ...
                        <div style="display: column;">
                            ...
                            <div class="form-group">
                                <label class="col-sm-1 control-label">Foja Inicial:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="fojaInicialEliminar" />
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-sm-1 control-label">Foja Final:</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" name="fojaFinalEliminar" />
                                </div>
                            </div>

                            <div class="form-group">
                                <button type="submit" class="btn btn-danger">Eliminar Imágenes</button>
                            </div>
                        </div>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <div class="form-group">
                    <button class="btn btn-info" onclick="openBisPage()">Imágenes Bis</button>
                    <button class="btn btn-info">Notas Centrales</button>
                </div>
            </div>
