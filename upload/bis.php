    ...
    <div class="main">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <h3>Administrar imágenes BIS</h3>
            </div>
            <div class="panel-body">
                <form action="cargarBis.php" method="post" enctype="multipart/form-data">

                    <div style="display: column;">
                        <label class="col-sm-1 control-label">No. Foja:</label>
                        <div class="form-group">
                            <div class="col-sm-3">
                                ...
                                <select name="tipo_imagen" id="tipo_imagen" required>
                                    ...
                                    <option value="bisv">bisv</option>
                                    <option value="bis2">bis2</option>
                                    <option value="bis2v">bis2v</option>
                                    <option value="bis3">bis3</option>
                                    <option value="bis3v">bis3v</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div style="display: column;">
                        ...
                        <div class="form-group">
                            <!-- <label class="col-sm-1 control-label">Seleccione la imagen:</label> -->
                            <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4">
                                <button type="submit" name="action" value="upload" class="btn btn-primary" onclick="toggleRequired(true)">Cargar imagen</button>
                            </div>
                        </div>

                        <div class="form-group">
                            <div class="col-sm-4">
                                <button type="submit" name="action" value="delete" class="btn btn-danger" onclick="toggleRequired(false)">Eliminar imagen</button>
                            </div>
                        </div>
