async function generateCertificadoSimple(registro, nombres, fojaInicial, numero, ano) {
    ...
    const detalleCompleto = `El Conservador de Bienes Raíces de Llay-Llay y Catemu certifica: que la inscripción de fojas ${formattedFojaInicial}  No. ${numero} del Registro de ${registro} del año ${ano}, está conforme con su original.`;
